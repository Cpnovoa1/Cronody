...
<body>
	...
	if ( $resultado ) {
		...
		$auditoria = mysqli_query($conn, "INSERT INTO `auditoria`(`USU_CODIGO`, `AUD_IP`, `AUD_EVENTO`, `AUD_HORA`, `AUD_FECHA`) VALUES (1,'$myIP','Agrego Nivel: $subnivel $nombre',curTime(),CURDATE())");
	} else {
