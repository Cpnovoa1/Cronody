...
<div class="contenedor">
	...
	<div class="cuerpo">
		<div class="info-user">
			<div class="pag-icono"><img src="../img/logo-docente_osc.svg" width="100px" height="100px" alt="profileImg" class="menu3"></div>
			<div class="pag-box">
		...
		<div class="info-pag">
			...
			<a href="solicitar_horario_docente.php">Ver mi horario</a>
