...
<body>
	<hr size="2px" color="black" />
		<h1><div align="center">Supervisores</div></h1>
	<hr size="2px" color="black" />
	<br>
	<br>
	...
	$activos=mysqli_query($conn,"select * from supervisor where SUP_ESTADO=1");
	$desactivos=mysqli_query($conn,"select * from supervisor where SUP_ESTADO=0");
	?>

	<div class="filtro">
		<form id="form1" name="form1" method="post" action="mostrar_supervisores.php">
