...
<div class="contenedor">
	...
	<div class="opciones">
		...
		<div class="imprimir"><a href="../impresion/final/index.php"><input type="button" value="Imprimir"></a></div>
		</form></div>
	</div>
...
$(document).ready(function(){
		...
		$('#idparal').change(function(){
			...
			$("#idparal option:selected").each(function () {
				paralelo = $(this).val();
				$.post("desplegarhorario_mostrar.php", { paralelo: paralelo }, function(data){
					$("#idtabla").html(data);
				}); 
			});
		});	
