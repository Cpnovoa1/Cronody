...
if($validacion == '1'){
	...
	$insertar = "INSERT INTO `horarios_materias`(`HOR_CODIGO`, `MAT_CODIGO`, `DIA_CODIGO`, `HMA_HORAINICIO`, `HMA_HORAFIN`) VALUES ('$horario','$materia','$dia','$horaIni','$horaFin')";
	$result2 = mysqli_query( $conn, $insertar );
	$myIP=getRealIP();
	if($result2){
		echo '<script>
