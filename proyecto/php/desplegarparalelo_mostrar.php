...
$curso=$_POST['curso'];
	...
	$sql="Select * From paralelo p, horarios h Where (p.HOR_CODIGO=h.HOR_CODIGO and h.HOR_ESTADO = 1 )  AND p.AUL_ESTADO=1 AND p.AUL_CURSO = '$curso' Group by p.AUL_CURSO, p.AUL_NOMBRE  Order by p.AUL_NOMBRE";
