...
<div class="contenedor2">
	<div class="cabeza">Agregar en Horario</div>
	<?php
	...
	?>
	<div class="cuerpo2">
	<form name="form1" id="form1" method="post" action="agregar_horario_materia_controlador.php">
	<div class="cont-tabla">
		<input type="text" name="id" value="<?php echo $id; ?>" hidden>
		<input type="text" name="horario" value="<?php echo $hor; ?>" hidden>
		<?php
		$buscar = mysqli_query($conn, "Select * From paralelo Where AUL_CODIGO = '$par'");
		while($row = mysqli_fetch_array($buscar)){
			$aula = $row[3].' "'.$row[2].'"';
		}
		?>
		<p><label style="opacity: 0.6; margin: 0 0 5px 5px;"><?php echo $aula;?></label></p>
