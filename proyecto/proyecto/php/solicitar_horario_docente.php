...
<div class="contenedor">
	...
	$result = mysqli_query( $conn, "Select * From horarios_materias o, horarios h, dias d, materias m, paralelo p, docente t Where o.HOR_CODIGO = h.HOR_CODIGO and o.DIA_CODIGO = D.DIA_CODIGO and o.MAT_CODIGO = m.MAT_CODIGO and p.HOR_CODIGO = h.HOR_CODIGO and m.DOC_CODIGO = t.DOC_CODIGO and t.DOC_CODIGO = '$codigo' ");
	...
	<div class="opciones">
		<div class="bloque"><form id="form1" name="form1" method="post" action="#">
			...
			<a href="../impresion/final/index_docente.php"><input type="button" value="Imprimir"></a>
		</form></div>
	</div>
