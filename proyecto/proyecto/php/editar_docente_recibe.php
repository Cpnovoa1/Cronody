...
<div class="contenedor2">
	<div class="cabeza">Editar Docente</div>
	<?php
	...
	$result = mysqli_query( $conn, "select * from docente where DOC_codigo='$id'" );
	?>
	<div class="cuerpo2">
	<form name="form1" id="form1" method="post" action="editar_docente_actualizar.php">
	<div class="cont-tabla">
	<?php
	//Mostramos los registros
	while ( $row = mysqli_fetch_array( $result ) ) {
		?>
		<input type="hidden" value="<?php echo $row["DOC_CODIGO"]; ?>" name="ide">
		...
		<input type="text" class="formulario__input" name="nombre" id="idnombre" value="<?php echo $row[ "DOC_NOMBRE" ]; ?>" placeholder="Ingrese el nombre" required><i class="formulario__validacion-estado fas fa-times-circle"></i>
		...
		<input type="text" class="formulario__input" name="apellido" id="idapellido" value="<?php echo $row[ "DOC_APELLIDO" ]; ?>" placeholder="Ingrese el apellido" required>
		...
		<input type="tel" class="formulario__input" name="telefono" id="idtelefono" value="<?php echo $row[ "DOC_TELEFONO" ]; ?>" placeholder="Ingrese el teléfono" required>
		<i class="formulario__validacion-estado fas fa-times-circle"></i>
		...
		<input type="date" class="formulario__input" name="fnac" value="<?php echo $row[ "DOC_FNACIMIENTO" ]; ?>" id="idfnacimiento" required ></div></div>
		
		<div class="row formulario__grupo" id="grupo__direccion"><p><label for="direccion" class="formulario__label">Dirección </label></p>
		<input type="text" class="formulario__input" name="direccion" id="iddireccion" value="<?php echo $row[ "DOC_DIRECCION" ]; ?>" placeholder="Ingrese la dirección" required>
		<i class="formulario__validacion-estado fas fa-times-circle"></i>
	...
	<div class="opciones">
		...
		<a href="editar_docente.php" id="idcancelar"><button type="button" value="cancelar">Cancelar</button></a>
	</div>
	</form>
